...
/*	sf::RectangleShape gR, aR, mR, aR2, tR;
	...
	Button aR_b(aR, 140, s1->getPrice(),30,20,225)
	Button mR_b(mR, 140, s1->getPrice(),30,20,225)
	Button aR2_b(aR2, 140, s1->getPrice(),30,20,225)
	Button tR_b(tR, 140, s1->getPrice(),30,20,225)
